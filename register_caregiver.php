<?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") 
		{
            ...
            {                
                ...
                echo 
                    '<script>
                        alert("Successfully Created Caregiver Account!");
        ...
        function Verify_Input($credentials, $sqlConnect, $localhost)
        {
            ...
            $query2 = "SELECT * FROM caregiver_and_guest_users WHERE ConnectedID = '$credentials[3]' AND Rights='3'";
        ...
        function CreateNewUser($sqlConnect, $credentials)
        {
            ...
            $query = "insert into users (Username, Rights, Password) values ('$username', '3', '$pass');";
            $result = mysqli_query($sqlConnect,$query);
            if(!$result){
